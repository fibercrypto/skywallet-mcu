...
lint: ## Check code quality
	...
	# Linter firmware
	$(PKG_CLANG_FORMAT) -i -assume-filename=.clang-format tiny-firmware/firmware/*.c
	$(PKG_CLANG_FORMAT) -i -assume-filename=.clang-format tiny-firmware/bootloader/*.c
	$(PKG_CLANG_FORMAT) -i -assume-filename=.clang-format tiny-firmware/emulator/*.c
