...
static const uint8_t* const pubkey[PUBKEYS] = {
    (const uint8_t*)"\x02\x42\x91\xe2\x42\x5a\x2f\xc7\xec\x7b\xd7\x5c\x81\x28"
                    "\x72\x6c\xa8\xcf\xb7\xce\x9c\x04\xae\x81\x86\xb6\x6c\x35"
                    "\x16\xf0\xf8\x0c\xd2",
    (const uint8_t*)"\x03\xe5\x92\xcb\x31\xc3\xc2\xcc\x9b\x38\x10\xe5\xc7\x82"
                    "\x98\x28\x0b\x0c\xc7\x85\xcd\x7f\x28\xe3\x6e\x13\x5a\xa8"
                    "\xa0\xfc\x74\xd0\x81",
    (const uint8_t*)"\x03\xb1\x55\xdf\x34\xb4\xc0\x87\x9f\xdd\x6b\xde\x2a\xcb"
                    "\x9c\x7a\x45\xe9\x3a\xa0\xbd\x0c\x69\x7f\x62\x92\xdc\x3d"
                    "\x1c\xb4\xc5\x96\xd6",
    (const uint8_t*)"\x02\x6d\x1d\x2e\x1c\x4a\xf5\xa2\xc8\x9e\x8e\x4c\x8b\xf7"
                    "\x24\x03\x4d\x02\x52\xeb\x8b\x91\x79\xfc\x6e\xec\x9c\xeb"
                    "\x8b\xb1\x73\x49\x97",
    (const uint8_t*)"\x03\x3b\xdf\x37\x75\x02\x78\x9d\x27\xa1\xd5\x34\x77\x53"
                    "\x92\xaf\x97\xa9\x33\x33\x18\x1b\x97\x36\x39\x5b\x3d\xb6"
                    "\x87\xce\xff\xc4\x73",
};
#endif
...
#if SIGNATURE_DEBUG
static void displaySignatureDebug(const uint8_t* hash,
    const uint8_t* signature,
    const uint8_t* pubk,
    const uint8_t* stored_pubkey)
{
...
int signatures_ok(uint8_t* store_hash)
{
    ...
    if (store_hash) { memcpy(store_hash, hash, 32); }
