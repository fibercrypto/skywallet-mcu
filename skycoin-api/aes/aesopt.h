...
#if defined(__GNUC__) && defined(__i386__) && !defined(__BEOS__) || defined(_WIN32) && defined(_M_IX86) && !(defined(_WIN64) || defined(_WIN32_WCE) || defined(_MSC_VER) && (_MSC_VER <= 800))
...
#if (defined(ASM_X86_V1C) || defined(ASM_X86_V2) || defined(ASM_X86_V2C)) && !defined(A32_) || defined(ASM_AMD64_C) && !defined(A64_)
